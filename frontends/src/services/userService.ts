...
export const getPublicUsers = (params?: { department_name?: string; plant_id?: number }) => 
  api.get("/api/users/public", { params });
...
export const uploadCsv = (formData: FormData) => api.post("/api/users/upload-csv", formData, {
  headers: {
