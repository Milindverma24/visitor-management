...
const Approvals = () => {
  ...
  const [activeTab, setActiveTab] = useState<"visitors">("visitors");
  ...
  const canApproveVisitor = true; // All roles can now approve
  const canApproveCurrent = true;
    ...
    try {
      ...
      const mergedData = visitsRes.data.map((visit: any) => {
        ...
        return {
          ...
          department: deptsMap.get(visit.department_id) || "General",
          ...
          <Card className="w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {['APPROVED', 'CHECKED_IN', 'CHECKED_OUT'].includes(selectedVisit.status) ? (
                  ...
                  <>
                    ...
                    <div className="space-y-4">
                      ...
                      {(selectedVisit.resume_path || selectedVisit.educational_certificates_path || selectedVisit.company_id_doc_path) && (
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="font-medium truncate">{selectedVisit.company}</p>
                          </div>
              ...
              {selectedVisit.status !== 'REJECTED' && selectedVisit.status !== 'EXPIRED' && (
                <div className="mt-8 flex flex-col sm:flex-row gap-3 border-t pt-4">
                  ...
                  {canApproveCurrent && selectedVisit.status === 'PENDING' && (
